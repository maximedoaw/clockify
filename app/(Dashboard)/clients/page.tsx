...
const ClientsPage = () => {
  ...
  return (
    <div className="flex flex-col gap-4 mt-16 p-6">
      <h1 className="text-2xl text-gray-400">Clients</h1>

      {/* SI PAS DE CLIENT → interface initiale */}
      {clients.length === 0 ? (
        <div className="flex flex-col gap-4 w-full">
          <div className="flex flex-col gap-4 w-full justify-center items-center mt-15">
            <h2 className="text-2xl">Add clients to organize your projects</h2>
            <p className="text-gray-400">
              Assign clients to projects, and keep track of each client's progress.
            </p>
          ...
          <Image src='/img21.PNG' alt='Clients' width={700} height={700} className='mx-auto'/>
        </div>
      ) : (
